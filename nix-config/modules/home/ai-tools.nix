...
in
{
  # xAI's official coding agent (`grok`); unfree, allowed per host.
  home.packages = [ pkgs.grok-build ];

  home.file = {
    ".codex/memories/user_preferences.md" = link ../../../codex/memories/user_preferences.md;
    ...
    ".codex/skills/commit-preferences" = link ../../../codex/skills/commit-preferences;
    ".codex/skills/pr-publishing-preferences" = link ../../../codex/skills/pr-publishing-preferences;
    ...
    ".claude/plugins/installed_plugins.json" = link ../../../claude/plugins/installed_plugins.json;
    ".claude/plugins/known_marketplaces.json" = link ../../../claude/plugins/known_marketplaces.json;
  };
}
